...
public class BulletTrap extends Bullet{
    Animation bullet;
    ParticularObject obj;
    public BulletTrap(float posX, float posY, float width, float height, Animation animation, ParticularObject obj, GameWorld gameWorld) {
